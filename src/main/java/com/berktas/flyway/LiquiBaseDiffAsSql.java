...
public class LiquiBaseDiffAsSql {
    ...
    public static void diff()
            throws LiquibaseException, IOException, ParserConfigurationException, SQLException {

        emptyTheFileBeforeDiff();

        Connection referenceConnection =
                DriverManager.getConnection("jdbc:mariadb://localhost:3306/school", "root", "12345");

        Connection targetConnection =
                DriverManager.getConnection("jdbc:mariadb://localhost:3306/empty_school", "root", "12345");
        ...
        try {
            ...
            new DiffToChangeLog(diffResult, new DiffOutputControl(false,false,false,null)).print("log.mysql.sql");
